...
impl Theme {
    pub fn framewise() -> Self {
        ...
        Self {
            ...
            paper_hover: ink.with_alpha_over(paper, 0.06),
            paper_press: ink.with_alpha_over(paper, 0.14),
            paper_elev_hover: ink.with_alpha_over(paper_elev, 0.06),
            paper_elev_press: ink.with_alpha_over(paper_elev, 0.14),
            rust_soft_on_paper: rust.with_alpha_over(paper, 0.14),
            rust_soft_on_paper_elev: rust.with_alpha_over(paper_elev, 0.14),
            line_on_paper: ink.with_alpha_over(paper, 0.20),
            line_soft_on_paper: ink.with_alpha_over(paper, 0.10),
            line_on_paper_elev: ink.with_alpha_over(paper_elev, 0.20),
            line_soft_on_paper_elev: ink.with_alpha_over(paper_elev, 0.10),
            scrollbar_track_on_paper: ink.with_alpha_over(paper, 0.04),
            scrollbar_track_on_paper_elev: ink.with_alpha_over(paper_elev, 0.04),
            h_sm: 22.0,
            h_md: 28.0,
            h_lg: 36.0,
            row_height: 26.0,
